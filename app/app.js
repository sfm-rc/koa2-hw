...
var _koaSend = require('koa-send');var _koaSend2 = _interopRequireDefault(_koaSend);
...
// logger
app.use(function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ctx, next) {var start, ms;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
...
app.use(function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(ctx, next) {var url, filePath;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            url = ctx.url;
            console.log('--------url:', url);if (!(
            url.indexOf('user-hw-static') > -1)) {_context2.next = 9;break;}
            filePath = url.substr(url.lastIndexOf('/'), url.length);
            console.log('---------filePath:', filePath);_context2.next = 7;return (
              (0, _koaSend2.default)(ctx, _path2.default.resolve('/public/dist' + filePath)));case 7:_context2.next = 11;break;case 9:_context2.next = 11;return (


              (0, _koaSend2.default)(ctx, _path2.default.resolve('/public/dist/index.html')));case 11:_context2.next = 13;return (

              next());case 13:case 'end':return _context2.stop();}}}, _callee2, undefined);}));return function (_x3, _x4) {return _ref2.apply(this, arguments);};}());


// response router
app.use(function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(ctx, next) {return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
            console.log('----api');_context3.next = 3;return (
              require('./routes').routes()(ctx, next));case 3:case 'end':return _context3.stop();}}}, _callee3, undefined);}));return function (_x5, _x6) {return _ref3.apply(this, arguments);};}());
...
// error logger
app.on('error', function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(err, ctx) {return _regenerator2.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
            console.log('error occured:', err);case 1:case 'end':return _context4.stop();}}}, _callee4, undefined);}));return function (_x7, _x8) {return _ref4.apply(this, arguments);};}());
