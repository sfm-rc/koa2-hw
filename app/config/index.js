...
var cfgs = []; /**
                ...
                */_fs2.default.readdirSync(__dirname).map(function (filename) {if (filename === 'index.js') {return false;}
  try {
...
var config = _lodash.defaultsDeep.apply(_lodash2.default, cfgs);exports.default =
