...
/**
                                                                                                                                ...
                                                                                                                                * @param {*} next
                                                                                                                                */
var join = function () {var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(ctx, next) {var params, user_name, user_name_alias, sex, mobile, down_payment, activity_id, extra, joinUser, activities, activity, sql, data, update_res;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
...
/**
                                                                                                                                                                      ...
                                                                                                                                                                      * @param {*} next
                                                                                                                                                                      */
var list = function () {var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(ctx, next) {var params, pageIndex, limit, activity_id, sql, c_sql, data, count;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
            params = ctx.request.body;
