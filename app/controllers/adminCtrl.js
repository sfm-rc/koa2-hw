...
/**
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     * @param {*} next 
                                                                                                                                                                                                                     */
var update = function () {var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(ctx, next) {var params, id, name, mobile, email, pwd, club_name, club_address_p, club_address_c, club_address_t, club_address_detail, contact_name, contact_mobile, contact_email, sql, res;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
            params = ctx.request.body;
            id =
            params.id, name = params.name, mobile = params.mobile, email = params.email, pwd = params.pwd, club_name = params.club_name, club_address_p = params.club_address_p, club_address_c = params.club_address_c, club_address_t = params.club_address_t, club_address_detail = params.club_address_detail, contact_name = params.contact_name, contact_mobile = params.contact_mobile, contact_email = params.contact_email;
            sql = 'update hw_admin set name=\'' + name + '\', mobile=\'' + mobile + '\', email=\'' + email + '\',\n              pwd=\'' +
            pwd + '\', club_name=\'' + club_name + '\', \n              club_address_p=\'' +
            club_address_p + '\', club_address_t=\'' + club_address_t + '\', club_address_c=\'' + club_address_c + '\',club_address_detail=\'' + club_address_detail + '\',\n              contact_name=\'' +
            contact_name + '\',\n              contact_mobile=\'' +
            contact_mobile + '\', \n              contact_email=\'' +
            ...
            ctx.body = { code: 0, message: 'success', data: res };case 8:case 'end':return _context5.stop();}}}, _callee5, undefined);}));return function update(_x9, _x10) {return _ref5.apply(this, arguments);};}();
...
/**
                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                         */
var get = function () {var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(ctx, next) {var params, admin_id, sql, res;return _regenerator2.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
            params = ctx.request.body;
            admin_id = params.admin_id;
            sql = 'select * from hw_admin where id=\'' + admin_id + '\'';
            console.log('get admin sql:', sql);_context6.next = 6;return (
              (0, _db_connection.query)(sql));case 6:res = _context6.sent;
            ctx.body = { code: 0, message: 'success', data: res };case 8:case 'end':return _context6.stop();}}}, _callee6, undefined);}));return function get(_x11, _x12) {return _ref6.apply(this, arguments);};}();exports.default =
...

{
  ...
  add: add,
  update: update,
  get: get };module.exports = exports['default'];
